...
<h2><?php echo (!empty($service_finder_options['label-profile-settings'])) ? esc_html($service_finder_options['label-profile-settings']) : esc_html__('Profile Settings', 'service-finder'); ?></h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group form-inline">
            <label>
            <?php esc_html_e('Gender', 'service-finder'); ?>
            </label>
            <br>
            <div class="radio sf-radio-checkbox">
              <input id="gendermale" type="radio" name="gender" value="male" <?php echo (get_user_meta($globalproviderid,'gender',true) == 'male') ? 'checked' : ''; ?>>
              <label for="gendermale">
              <?php esc_html_e('Male', 'service-finder'); ?>
              </label>
            </div>
            <div class="radio sf-radio-checkbox">
              <input id="genderfemale" type="radio" name="gender" value="female" <?php echo (get_user_meta($globalproviderid,'gender',true) == 'female') ? 'checked' : ''; ?>>
              <label for="genderfemale">
              <?php esc_html_e('Female', 'service-finder'); ?>
              </label>
            </div>
          </div>
        </div>
    ...
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label>
            <?php esc_html_e('Alt. Mobile', 'service-finder'); ?>
            </label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-globe"></i>
              <input type="text" class="form-control sf-form-control" name="website" value="<?php echo esc_attr($userInfo['website']) ?>">
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="input-group" id="cityautosuggestion"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
              ...
              if(!empty($cities)){
                foreach($cities as $term){
                    if($userInfo['city'] == $term->name){
                    $select = 'selected="selected"';
                    }else{
                    $select = '';
                    }
                    echo '<option '.$select.' value="'.esc_attr($term->name).'">'.$term->name.'</option>';
                }
              }
              ?>
              </select>
        ...
        <!-- <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-street-view"></i>
              <input type="text" class="form-control sf-form-control" name="lat" id="lat" value="<?php echo esc_attr($userInfo['lat']) ?>">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
  ...
  <div class="panel panel-default service-perform-here">
    <div class="panel-heading sf-panel-heading">
      <h3 class="panel-tittle m-a0"><span class="fa fa-building"></span> <?php esc_html_e('Radius for Service Area', 'service-finder'); ?> </h3>
    </div>
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <b class="sf-minimum-mile"><?php echo esc_html($minradiusrange).$radiusunit ?></b>
              <input id="serviceradius" name="serviceradius" type="text" data-slider-min="0" data-slider-max="<?php echo esc_attr($maxradiusrange); ?>" data-slider-step="1" data-slider-value="<?php echo esc_attr(get_user_meta($globalproviderid,'serviceradius',true)) ?>"/>
              
              <b class="sf-maximum-mile"><?php echo esc_html($maxradiusrange).$radiusunit ?></b>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group">
            <label>
            <?php esc_html_e('Amenities', 'service-finder'); ?>
            </label>
            <div class="input-group">
            <?php 
            if(!empty($userInfo['amenities'])){
            $allamenities = explode(',',$userInfo['amenities']);
            }else{
            $allamenities[] = $userInfo['amenities'];
            }

            ?>
              <select name="amenities[]" class="sf-multiple-categories-select sf-select-box form-control sf-form-control" multiple="multiple" id="amenities">
                <?php
                if(class_exists('service_finder_texonomy_plugin')){
                $limit = 1000;
                ...
                if(!empty($amenities)){
                    foreach($amenities as $amenity){
                        if(in_array($amenity->term_id,$allamenities)){
                        $select = 'selected="selected"';
                        }else{
                        $select = '';
                        }
                        echo '<option '.$select.' value="'.esc_attr($amenity->term_id).'">'. $amenity->name.'</option>';
                        ...
                        if(!empty($term_children)){
                            ...
                            foreach($namearray as $key => $value) {
                                ...
                                if(in_array($term_child_id,$allamenities)){
                                    $childselect = 'selected="selected"';
                                }else{
                                    $childselect = '';
                                }
        ...
        <div class="col-md-12">
          <div class="rwmb-field rwmb-oembed-wrapper">
            ...
            <div class="rwmb-input ui-sortable">
              <input type="url" size="30" placeholder="<?php echo esc_html__('Insert YouTube or Vimeo Video Url', 'service-finder') ?>" value="" id="embeded_code" name="embeded_code" class="rwmb-oembed valid form-control sf-form-control">
              ...
              <div class="sf-videothumbs">
                ...
                <?php
                if(isset($userInfo['embeded_code'])){
                ...
                if(!empty($embeded_codes)){
                    ...
                    $embeded_code = $userInfo['embeded_code'];
                    $thumbnail = service_finder_identify_videos($embeded_code);
