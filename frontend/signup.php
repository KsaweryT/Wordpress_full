...
?>
  ...
  <!-- Left & right section start -->
  		<?php
        echo '<div class="padding-20 margin-b-30  bg-white sf-rouned-box sf-register-page">
          <div class="tabbable">';
          if(!is_user_logged_in()){
            ...
            <div class="tab-content">';
			 ...
			 $citybox = '<input type="text" class="form-control" autocomplete="off" '.$readonly.' placeholder="'.$placeholder.'" name="signup_city" id="signup_city_bx" placeholder="'.esc_html__('Miasto', 'service-finder').'">';
			 }else{
                  ...
                  <div class="provider-bx clearfix row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="signup_first_name" type="text" class="form-control" placeholder="'.esc_html__('Imię', 'service-finder').'">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="signup_last_name" type="text" class="form-control" placeholder="'.esc_html__('Nazwisko', 'service-finder').'">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="signup_user_name" type="text" class="form-control" placeholder="'.esc_html__('Nazwa użytkownika', 'service-finder').'">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="signup_password" type="password" class="form-control" placeholder="'.esc_html__('Hasło', 'service-finder').'">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="signup_confirm_password" type="password" class="form-control" placeholder="'.esc_html__('Potwierdź hasło', 'service-finder').'">
                      </div>
                    </div>
					<div class="col-md-12">
                    <div class="form-group">
                      <input type="text" class="form-control" name="signup_phone" id="signup_phone" placeholder="'.esc_html__('Numer telefonu', 'service-finder').'">
                    </div>
                  </div>';
				  if(!$service_finder_options['quick-signup']){
				  echo '<div class="col-md-12">
                      <div class="form-group">
                        <input type="text" class="form-control" name="signup_address" id="signup_address_bx" placeholder="'.esc_html__('Adres', 'service-finder').'">
                      </div>
                    </div>
					<div class="col-md-6">
                      <div class="form-group">
                      <select class="sf-select-box form-control sf-form-control" name="signup_country" data-live-search="true" title="'.esc_html__('Kraj', 'service-finder').'" id="signup_country_bx">
                      <option value="">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" class="form-control" name="signup_state" id="signup_state_bx" placeholder="'.esc_html__('Województwo', 'service-finder').'">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" class="form-control" name="signup_zipcode" id="signup_zipcode_bx" placeholder="'.esc_html__('Kod pocztowy', 'service-finder').'">
                      </div>
                    </div>';
					}
                    echo '<div class="col-md-6">
                      <div class="form-group has-select">
                        <select class="sf-select-box form-control sf-form-control" name="signup_category" data-live-search="true" title="'.esc_html__('Kategoria', 'service-finder').'">
                          <option value="">
						  ...
						  echo '<div class="col-md-6">
							  <div class="form-group">
								<select name="provider-role" class="form-control sf-form-control sf-select-box">
								  ...
								  '.esc_html__('Wybierz pakiet', 'service-finder').'
								  </option>
					...
					$displayfree = ($packagenumber > 0) ? '' : $displayfree;						
...
$label = '<img src="'.SERVICE_FINDER_BOOKING_IMAGE_URL.'/payment/paypal.jpg" title="'.esc_html__('Paypal','service-finder').'" alt="'.esc_html__('Paypal','service-finder').'">';
				  ...
				  $pactype = ($free || $withoutpackage) ? 'yes' : 'no';
                    echo '<div class="col-md-12">
                      ...
                      <input type="submit" class="btn btn-primary btn-block" name="user-register" value="'.esc_html__('Zarejestruj się', 'service-finder').'" />
                    </div>
                    <div class="col-md-12 text-center"> <small><a href="'.esc_url($loginpage).'">
                      '.esc_html__('Masz już konto?', 'service-finder').'
                      </a></small> </div>
                  </div>
                </form>';
              ...
              echo '<div id="customertab" class="tab-pane fade '.$proactive.'">
                <form class="customer_registration_page" method="post">
                  ...
                  echo '<div class="col-md-12">
                    ...
                    <div class="col-md-12 text-center"> <small><a href="'.esc_url($loginpage).'" class="loginform">
                      '.esc_html__('Masz już konto?', 'service-finder').'
                      </a></small> </div>
                  </div>
                </form>';
