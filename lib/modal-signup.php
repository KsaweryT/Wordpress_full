  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content login-bx-dynamic">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          <?php esc_html_e('Zaloguj się', 'service-finder'); ?>
        </h4>
      </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="input-group"> <i class="input-group-addon fa fa-lock"></i>
                  <input name="login_password" type="password" class="form-control" placeholder="<?php esc_html_e('Hasło', 'service-finder'); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary btn-block" name="user-login" value="<?php esc_html_e('Zaloguj się', 'service-finder'); ?>" />
              </div>
            </div>
            <div class="col-md-12 text-center"> <small><a href="javascript:;" class="regform">
              <?php esc_html_e('Nie posiadasz konta?', 'service-finder'); ?>
              </a> | <a href="javascript:;" class="forgotpassform">
              <?php esc_html_e('Zapomniałem hasła', 'service-finder'); ?>
              </a></small> </div>
          </form>
    ...
    <div class="modal-content register-modal hidden">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h4 class="modal-title">
          <?php esc_html_e('Zarejestruj się', 'service-finder'); ?>
        </h4>
      </div>
      <div class="modal-body clearfix">
        <div class="tabbable">
            ...
            <div id="tab2" class="tab-pane fade in active">
              <form class="provider_registration" method="post">
                <div class="provider-bx clearfix row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <input name="signup_first_name" type="text" class="form-control" placeholder="<?php esc_html_e('Imię', 'service-finder'); ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <?php if($show_signup_otp){ ?>
                    <div class="col-md-12">
                      <div class="form-group signupotp-section">
                        <label>
                        <?php esc_html_e('Jednorazowe hasło', 'service-finder'); ?>
                        </label>
                        <div class="input-group"> <i class="input-group-addon fa fa-lock"></i>
                          <input id="fillsignupotp" name="fillsignupotp" type="text" class="form-control" value="">
                        </div>
                        <a href="javascript:;" class="signupotp">
                        <?php esc_html_e('Wygeneruj jednorazowe hasło, aby potwierdzić email', 'service-finder'); ?>
                        </a> </div>
                    </div>
                    <?php } ?>
                  <?php 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <input name="signup_confirm_password" type="password" class="form-control" placeholder="<?php esc_html_e('Potwierdź hasło', 'service-finder'); ?>">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="text" class="form-control" name="signup_phone" id="signup_phone" placeholder="<?php esc_html_e('Nr telefonu', 'service-finder'); ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group has-select">
					  ...
					  $placeholder = esc_html__('Miasto (Wybierz najpierw kraj, aby umożliwić wybór)','service-finder');
					  ?>
                      <select class="sf-select-box form-control" name="signup_country" data-live-search="true" title="<?php esc_html_e('Kraj', 'service-finder'); ?>" id="signup_country">
                      <option value="">
                        <?php esc_html_e('Wybierz kraj', 'service-finder'); ?>
                        </option>
					  <?php
					  ...
					  if($allcountry){
						 ...
						 if($countryarr){
							...
							if($totalcountry == 1){
								...
								$readonly = '';
								$disabled = '';
								$placeholder = esc_html__('Wybierz miasto','service-finder');
							}else{
								$select = '';
							}
                  ...
                  <div class="col-md-6">
                    ...
                    <select <?php echo $readonly; ?> <?php echo $disabled; ?> class="form-control sf-form-control sf-select-box" name="signup_city" data-live-search="true" title="<?php echo $placeholder; ?>" id="signup_city">
                      <option value="">
                        <?php esc_html_e('Wybierz miasto', 'service-finder'); ?>
                        </option>
                      </select>
                    <?php } ?>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control" name="signup_apt" placeholder="<?php esc_html_e('Nr domu/mieszkania', 'service-finder'); ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control" name="signup_state" id="signup_state" placeholder="<?php esc_html_e('Województwo', 'service-finder'); ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control" name="signup_zipcode" id="signup_zipcode" placeholder="<?php esc_html_e('Kod pocztowy', 'service-finder'); ?>">
                    </div>
                  </div>
                  <?php } ?>
                  <div class="col-md-6">
                    <div class="form-group has-select">
                      <select class="sf-select-box form-control" name="signup_category" data-live-search="true" title="<?php esc_html_e('Kategoria', 'service-finder'); ?>">
                        <option value="">
                        <?php esc_html_e('Wybierz kategorię', 'service-finder'); ?>
                        </option>
                        <?php
					  ...
					  <div class="col-md-6">
                        <div class="form-group">
                          <select name="provider-role" class="form-control sf-form-control sf-select-box">
                            ...
                            <?php esc_html_e('Wybierz pakiet', 'service-finder'); ?>
                            </option>
                    ...
                    <div class="form-group form-inline">
                      <?php
																...
																if($paymentflag == 0){
																	...
																	echo esc_html__('Ta metoda płatności jest niedostępna.', 'service-finder');
																	echo '</div>';
																}
																?>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="submit" class="btn btn-primary btn-block" name="user-register" value="<?php esc_html_e('Zarejestruj się', 'service-finder'); ?>" />
                  </div>
                  <div class="col-md-12 text-center"> <small><a href="javascript:;" class="loginform">
                    <?php esc_html_e('Masz już konto?', 'service-finder'); ?>
                    </a></small> </div>
                </div>
              </form>
            ...
            <div id="tab1" class="tab-pane fade customer-signup-tab-content">
              <form class="customer_registration" method="post">
                <div class="customer-bx clearfix row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <input name="signup_password" type="password" class="form-control" placeholder="<?php esc_html_e('Hasło', 'service-finder'); ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="row ">
          <form class="forgotpassform" method="post">
            <div class="col-md-12">
              <div class="form-group">
                <div class="input-group"> <i class="input-group-addon fa fa-user"></i>
                  <input name="fp_user_login" id="fp_user_login" type="text" class="form-control" placeholder="<?php esc_html_e('Nazwa użytkownika lub e-mail:', 'service-finder'); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary btn-block" name="user-login" value="<?php esc_html_e('Zresetuj hasło', 'service-finder'); ?>" />
              </div>
            </div>
            <div class="col-md-12 text-center"> <small><a href="javascript:;" class="regform">
              <?php esc_html_e('Nie posiadasz konta?', 'service-finder'); ?>
