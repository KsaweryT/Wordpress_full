...
$showadminfee = '<li>'.esc_html__('Koszt rezerwacji', 'service-finder').': <strong><span id="bookingfee"></span></strong> </li>';
$showadminfee .= '<li>'.sprintf( esc_html__('%s', 'service-finder'), $admin_fee_label ).': <strong><span id="bookingadminfee"></span></strong> </li>';
$showadminfee .= '<li>'.esc_html__('Suma', 'service-finder').': <strong><span id="totalbookingfee"></span></strong> </li>';
				...
				<div id="pricebox" class="acod-body collapse in">
					<div class="acod-content">
						<div class="booking-panel-step-one">
							<h3 id="job-booking-title"></h3>
							<span class="booking-panel-price" id="job-booking-price"></span>
							<a href="javascript:;" class="booking-panel-price-edit btn btn-sm editprice"><i class="fa fa-pencil"></i> <?php esc_html_e('Edit', 'service-finder'); ?></a>
                            <div class="booking-update-box" id="editpricebox" style="display:none">
                            ...
                            <div class="booking-panel-btn-wrap"> 
                                <button type="button" class="btn btn-custom continuetodatetime"><?php esc_html_e('Kontynuuj', 'service-finder'); ?></button> 
                            </div>
						</div>
					</div>
				</div>
				...
				<div id="datetimebox" class="acod-body collapse">
					<div class="acod-content">
						<div class="booking-panel-step-three">
                            ...
                            <div class="booking-panel-btn-wrap"> 
                                <button type="button" class="btn btn-primary backtopricebox"><?php esc_html_e('Wróć', 'service-finder'); ?></button>
                                <button type="button" class="btn btn-custom continuetocustomerinfo"><?php esc_html_e('Kontynuuj', 'service-finder'); ?></button> 
                            </div>            
                        </div>
					</div>
				</div>
			...
			<div class="panel">
				<div class="acod-head">
				 <h5 class="acod-title">
					...
					<?php esc_html_e('Informacje o kliencie', 'service-finder'); ?>
					<span class="indicator"><i class="fa fa-plus"></i></span>
					</a>
				 </h5>
				</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>
                                        <?php esc_html_e('Imię', 'service-finder'); ?>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>
                                        <?php esc_html_e('Nazwisko', 'service-finder'); ?>
                                        </label>
                                        <div class="input-group"> <i class="input-group-addon fa fa-user"></i>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>
                                        <?php esc_html_e('Nr telefonu', 'service-finder'); ?>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>
                                        <?php esc_html_e('Kraj', 'service-finder'); ?>
                                        </label>
                                        <div class="input-group"> <i class="input-group-addon fa fa-map-marker"></i>
                                    ...
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        <label>
                                        <?php esc_html_e('Szczegóły dla sprzątaczki', 'service-finder'); ?>
                                        </label>
                                        <div class="input-group"> <span class="input-group-addon v-align-t"><i class="fa fa-pencil"></i></span>
                                          <textarea id="shortdesc" name="shortdesc" class="form-control sf-form-control" placeholder="<?php esc_html_e('Zamieść krótki opis.', 'service-finder'); ?>"></textarea>
                                        </div>
                                      </div>
                                    </div>
                                </div>
                                <div class="booking-panel-btn-wrap"> 
                                    <button type="button" class="btn btn-primary backtodatetimebox"><?php esc_html_e('Wróć', 'service-finder'); ?></button>
                                    <button type="button" class="btn btn-custom continuetopayment"> <?php esc_html_e('Przejdź do płatności', 'service-finder'); ?></button> 
                                </div>
                            </div>
						</div>
					</div>
			...
			<div class="panel" id="jobbooking-paid-panel">
				<div class="acod-head">
				 <h5 class="acod-title">
					...
					<?php esc_html_e('Płatność', 'service-finder'); ?>
					<span class="indicator"><i class="fa fa-plus"></i></span>
					</a>
				 </h5>
				</div>
                          ...
                          <?php echo service_finder_display_wallet_amount($current_user->ID); ?> 
                            ...
                            <div id="bookingcardinfo" class="default-hidden">
                              <div class="col-md-8">
                                <div class="form-group">
                                  <label>
                                  <?php esc_html_e('Nr karty', 'service-finder'); ?>
                                  </label>
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label>
                                  <?php esc_html_e('Kod CVC', 'service-finder'); ?>
                                  </label>
                              ...
                              <div class="col-md-6">
                                <div class="form-group has-select">
                                  <label>
                                  <?php esc_html_e('Wybierz miesiąc', 'service-finder'); ?>
                                  </label>
                                  <select id="card_month" name="card_month" class="form-control sf-form-control sf-select-box" title="Select Month">
                                      <option value="1"><?php echo esc_html__('Styczeń', 'service-finder') ?></option>
                                      <option value="2"><?php echo esc_html__('Luty', 'service-finder')?></option>
                                      <option value="3"><?php echo esc_html__('Marzec', 'service-finder')?></option>
                                      <option value="4"><?php echo esc_html__('Kwiecień', 'service-finder')?></option>
                                      <option value="5"><?php echo esc_html__('Maj', 'service-finder')?></option>
                                      <option value="6"><?php echo esc_html__('Czerwiec', 'service-finder')?></option>
                                      <option value="7"><?php echo esc_html__('Lipiec', 'service-finder')?></option>
                                      <option value="8"><?php echo esc_html__('Sierpień', 'service-finder')?></option>
                                      <option value="9"><?php echo esc_html__('Wrzesień', 'service-finder')?></option>
                                      <option value="10"><?php echo esc_html__('Październik', 'service-finder')?></option>
                                      <option value="11"><?php echo esc_html__('Listopad', 'service-finder')?></option>
                                      <option value="12"><?php echo esc_html__('Grudzień', 'service-finder')?></option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group has-select">
                                  <label>
                                  <?php esc_html_e('Wybierz rok', 'service-finder'); ?>
                                  </label>
                            ...
                            <div id="bookingpayulatamcardinfo" class="default-hidden">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label>
                                    <?php esc_html_e('Wybierz kartę', 'service-finder'); ?>
                                    </label>
                                    <select id="payulatam_cardtype" name="payulatam_cardtype" class="form-control sf-form-control sf-select-box"  title="<?php esc_html_e('Wybierz kartę', 'service-finder'); ?>">
                                      <?php
                                ...
                                <div class="col-md-6">
                                  <div class="form-group has-select">
                                    ...
                                    <select id="payulatam_card_month" name="payulatam_card_month" class="form-control sf-form-control sf-select-box" title="<?php esc_html_e('Wybierz miesiąc', 'service-finder'); ?>">
                                      <option value="01"><?php echo esc_html__('Styczeń', 'service-finder') ?></option>
                                      <option value="02"><?php echo esc_html__('Luty', 'service-finder')?></option>
                                      <option value="03"><?php echo esc_html__('Marzec', 'service-finder')?></option>
                                      <option value="04"><?php echo esc_html__('Kwiecień', 'service-finder')?></option>
                                      <option value="05"><?php echo esc_html__('Maj', 'service-finder')?></option>
                                      <option value="06"><?php echo esc_html__('Czerwiec', 'service-finder')?></option>
                                      <option value="07"><?php echo esc_html__('Lipiec', 'service-finder')?></option>
                                      <option value="08"><?php echo esc_html__('Sierpień', 'service-finder')?></option>
                                      <option value="09"><?php echo esc_html__('Wrzesień', 'service-finder')?></option>
                                      <option value="10"><?php echo esc_html__('Październik', 'service-finder')?></option>
                                      <option value="11"><?php echo esc_html__('Listopad', 'service-finder')?></option>
                                      <option value="12"><?php echo esc_html__('Grudzień', 'service-finder')?></option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group has-select">
                                    ...
                                    <select id="payulatam_card_year" name="payulatam_card_year" class="form-control sf-form-control sf-select-box"  title="<?php esc_html_e('Wybierz rok', 'service-finder'); ?>">
                                      <?php
                                                                $year = date('Y');
                                                                for($i = $year;$i<=$year+50;$i++){
                                                                    echo '<option value="'.$i.'">'.$i.'</option>';
                            ...
                            <div class="col-md-12" id="sf-bookform-submitarea">
                              <div class="form-group">
                                <input name="book-now" id="save-booking" type="submit" value="<?php esc_html_e('Zapłać teraz', 'service-finder'); ?>" class="btn btn-primary center-block">
                              </div>
                            </div>
                            <?php }else{
                            echo '<p>';
                            echo esc_html__('Nie ma dostępnej metody płatności.','service-finder');
                            echo '</p>';
                            } ?>
                          </div> 
                    </div>
