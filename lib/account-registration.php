...
if(isset($_GET['registerviapayumoney']) && $_GET['registerviapayumoney'] == 'success' && $_GET['payutransactionforreg'] == 'success' && isset($_GET['payutransactionforreg']) && isset($_POST['payuMoneyId']) && isset($_POST['status'])){
...
function service_finder_update_activationTime($id, $role) {
...
function service_finder_SendSubscriptionNotificationMail($userid, $days = '',$by = ''){
...
function service_finder_expireProviderUser($userId) {
	global $wpdb, $service_finder_options, $service_finder_Tables;
...
function service_finder_sedateUserRegistration($arg){
...
if(email_exists( esc_attr($arg['signup_user_email']) )){
	...
	if($arg['signup_user_role'] == 'Provider'){
		...
		$data = array(
					...
					'company_name' => (!empty($arg['signup_company_name'])) ? esc_attr($arg['signup_company_name']) : '',
					
					'full_name' => esc_attr($arg['signup_first_name']).' '.esc_attr($arg['signup_last_name']),

					'email' => (!empty($arg['signup_user_email'])) ? esc_attr($arg['signup_user_email']) : '',
					
					'phone' => (!empty($arg['signup_phone'])) ? esc_attr($arg['signup_phone']) : '',
...
function service_finder_sendProviderEmail($args,$invoiceid = ''){
global $wpdb, $service_finder_Tables, $service_finder_options;			
...
function service_finder_sendUpgradeMailToUser($username,$email,$args){
global $wpdb, $service_finder_Tables, $service_finder_options;			
...
function service_finder_sendProviderUpgradeEmail($args){
global $wpdb, $service_finder_Tables, $service_finder_options;			
...
function service_finder_sendWiredUpgradeMailToProvider($username,$email,$args){
global $wpdb, $service_finder_Tables, $service_finder_options;			
...
function service_finder_sendProviderWiredUpgradeEmail($args,$invoiceid = ''){
global $wpdb, $service_finder_Tables, $service_finder_options;			
